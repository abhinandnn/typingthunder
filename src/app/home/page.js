...
openPopup();
  ...
  return (
    ...
    <div className='relative'>
        <div className={`flex flex-row justify-start items-center gap-[6rem] md:gap-[3.6rem]  xl:gap-[8rem]`}><div className='flex cursor-pointer flex-row gap-2 justify-center items-center mob:text-[1.375rem] text-[1rem] text-[#e6e6e6]'><svg className='hidden mob:flex' width="33" height="31" viewBox="0 0 33 31" fill="none" xmlns="http://www.w3.org/2000/svg">
