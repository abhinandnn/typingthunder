...
const handleGoogle = async (event) => {
  ...
  return (
    <div className='bg-[#1a1a1a] font-Poppins min-h-[100vh] min-w-[80vw] px-[10vw] md:px-[7.4rem] py-[2rem]'>
...
<div className='text-[0.9rem] mob:text-[1.15rem] sm:hidden cursor-pointer text-white'>Test</div>
    ...
    name="user" className={`w-[80vw] sm:w-[31.5rem] h-[4.5rem] peer rounded-[1.25rem] ${(!error)?'bg-transparent border-dgr':'bg-[#190F0F] border-[#FF7E7E]'} border  px-[1rem] focus:pt-[0.75rem] ${!inputValue? 'pt-0':'pt-[0.75rem]'} outline-none box-border`}/> 
