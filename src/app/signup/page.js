...
function Signup() {
  ...
  return (
    <div className='bg-[#1a1a1a] font-Poppins min-h-[100vh] min-w-[100vw] px-[10vw] md:px-[7.4rem] py-[2rem]'>
        <div className='flex flex-row items-center justify-between'><div onClick={()=>router.push('/home')} className='flex cursor-pointer flex-row gap-2 justify-center items-center text-[1rem] mob:text-[1.375rem] text-[#e6e6e6]'><svg className='hidden mob:inline' width="33" height="31" viewBox="0 0 33 31" fill="none" xmlns="http://www.w3.org/2000/svg">
