...
function SpeedTestMulti({setPhase, setMultiWPM, setMultiAccu, setPosition}) {
...
useEffect(()=>{
    setPosition(((currIndex+1)*100/apiResponse.length).toFixed(0));                                                                                                                                       
},[currIndex])
